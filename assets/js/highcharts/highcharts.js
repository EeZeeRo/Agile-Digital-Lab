...
(function(Z, M) {
    ...
    M(a, "Core/Color/Palettes.js", [], function() {
        return {
            colors: "#7cb5ec #434348 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1 #FF8277 #A266C8 #339BC7".split(" ")
        }
    });
        ...
        var v = G.merge,
            A = {
                ...
                lang: {
                    ...
                    shortMonths: "Янв Фев Мар Апр Май Июнь Июль Авг Сен Окт Ноя Дек".split(" "),
