    ...
    k(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function(a) {
        var f = a.isSafari,
            ...
            r = a.dataURLtoBlob = function(a) {
                if ((a = a.replace(/filename=.*;/, "").match(/data:([^;]*)(;base64)?,([0-9A-Za-z+/]+)/)) && 3 < a.length&&d.atob&&d.ArrayBuffer&&d.Uint8Array&&d.Blob&&l.createObjectURL){var f= d.atob(a[3]), m = new d.ArrayBuffer(f.length); m = new d.Uint8Array(m);
                    for (var b = 0; b < m.length; ++b) m[b] = f.charCodeAt(b); a = new d.Blob([m], {
                        type: a[1]
                    });
